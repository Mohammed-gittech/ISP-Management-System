...
namespace ISP.Infrastructure.Migrations
{
    ...
    [Migration("20260313222615_AddSecurityAlerts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISP.Domain.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISP.Domain.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISP.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISP.Domain.Entities.SecurityAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISP.Domain.Entities.TenantPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISP.Domain.Entities.Payment", b =>
                {
                    b.HasOne("ISP.Domain.Entities.Invoice", "Invoice")
                        .WithOne("Payment")
                        .HasForeignKey("ISP.Domain.Entities.Payment", "InvoiceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ISP.Domain.Entities.User", "ReceivedByUser")
                        .WithMany()
                    ...
                    b.HasOne("ISP.Domain.Entities.Subscription", "Subscription")
                        .WithMany()
            ...
            modelBuilder.Entity("ISP.Domain.Entities.TenantPayment", b =>
                {
                    ...
                    b.HasOne("ISP.Domain.Entities.TenantSubscription", "TenantSubscription")
                        .WithMany()
